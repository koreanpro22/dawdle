  ...
  return (
    <div className="lg:w-[90%] flex flex-col lg:flex-row m-auto lg:h-screen p-[3vh] max-h-[120dvh] h-[120dvh] overflow-hidden">
      <div className="lg:my-auto mx-auto flex flex-col lg:justify-center">
        ...
        <div className="z-10 lg:w-full w-[80%] lg:my-0 lg:mx-0 mx-auto flex flex-col gap-3 my-5 pb-5">
          <p
          ...
          <div className="flex flex-col lg:flex-row lg:w-full justify-center lg:gap-[2vh] gap-[1vh] relative">
            <input
            ...
            />
            <button
              className="w-full animate-fadeIn self-end bg-primary-accent-color text-primary-text-color py-3 px-5 rounded-full"
              type="submit"
